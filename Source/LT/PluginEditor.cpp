      ...
      delaySlider ("delay")
{
    ...
    bpmSlider.setRange (0.1, 2.0, 0.01);
    ...
    gainLabel.attachToComponent (&bpmSlider, false);
    ...
    addAndMakeVisible(myAudioUI = new audioPlayerUI(ownerFilter->myAudioPlayer));
    
    myAudioUI->setBounds(100,100, 200,200);
...
void JuceDemoPluginAudioProcessorEditor::resized()
{
    ...
    bpmSlider.setBounds (20, 60, 150, 40);
...
void JuceDemoPluginAudioProcessorEditor::sliderValueChanged (Slider* slider)
{
    if (slider == &bpmSlider)
    {
      ...
      //  getProcessor()->myAudioPlayer->changeTempo(bpmSlider.getValue());
        
        getProcessor()->myAudioPlayer->timeStretch->setValue(bpmSlider.getValue());      
        
        // It's vital to use setParameterNotifyingHost to change any parameters that are automatable
        // by the host, rather than just modifying them directly, otherwise the host won't know
        // that they've changed.
       // getProcessor()->setParameterNotifyingHost (JuceDemoPluginAudioProcessor::gainParam,
         //                                          (float) bpmSlider.getValue());
    }
